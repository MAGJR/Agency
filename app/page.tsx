 ...
 const isDescriptionInView = useInView(descriptionRef, {margin:"-150px"})
  ...
  return (
   ...
   <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 items-center justify-center ">
    {/* TITLE */}
    <h1 className="text-4xl md:text-4xl font-bold ">Nós ajudamos empresas a escalarem através de tráfego pago</h1>
    {/* DESC */}
...
<p className="">É hora de fazer valer seu orçamento de publicidade, expandir seus negócios e aumentar suas vendas.</p>
   ...
   <div className="lg:w-full flex gap-4" >
    ...
    className="p-4 rounded-lg ring-1 ring-emerald-300 bg-emerald-300 text-back" >Veja nosso Trabalho</motion.button>
    <motion.button 
    whileHover={{ scale: 1.05 }}
    transition={{ type: "spring", stiffness: 300 }}
