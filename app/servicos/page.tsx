...
const items = [
    ...
    {
      id: 4,
      color: "from-blue-300 to-emerald-300",
    ...
    return (
        ...
        <div className='sticky top-0 flex h-screen gap-4 items-center overflow-hidden'>
          ...
          <Link href={item.link} className='flex justify-end'>
            <button className='p-2 text-sm md:p-4 md:text-md lg:text-lg bg-white text-gray-600 font-semibold mb-4 rounded'>See More</button></Link>
          </div>
          </div>))}
            </motion.div>
            </div>
